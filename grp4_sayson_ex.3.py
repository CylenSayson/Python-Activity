...
# Using + Concatenate Strings in Python using 4 variables and concatenate them with spaces.
# Using + Concatenate Strings in Python get two strings from user input and concatenate them.
# Using + Concatenate Strings in Python using your name and your age in a paragraph.
"""
...
if __name__ == "__main__":
    ...
    print(name_and_age_paragraph("Cylen", 22))
